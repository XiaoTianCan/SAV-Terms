...
informative:
  ...
  savi-charter:
    title: Charter for SAVI Working Group
    author:
    org: IETF
    date: 2008-07
    target: https://datatracker.ietf.org/wg/savi/about/
...
The following acronyms are commonly used in the context of source address validation:
...
- **BAR-SAV:** Source Address Validation Using BGP UPDATEs, ASPA, and ROA
...
- **Source Address Validation Improvements (SAVI):** A set of access-network SAV mechanisms that provide fine-grained source address validation and prevent nodes attached to the same IP link from spoofing each other's IP addresses {{savi-charter}}.
